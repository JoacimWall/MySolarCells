...
`,yt=[{key:"own_use_kwh",label:"Own Use",color:"#4285f4",unit:"kWh"},{key:"sold_kwh",label:"Sold",color:"#34a853",unit:"kWh"},{key:"own_use_sek",label:"Own Use",color:"#8ab4f8",unit:"SEK"},{key:"sold_sek",label:"Sold",color:"#f4a742",unit:"SEK"}],mt=[{key:"today",label:"Today"},{key:"this_week",label:"This Week"},{key:"this_month",label:"This Month"},{key:"this_year",label:"This Year"}];let ft=class extends nt{render(){if(!this.data)return V;const t=this._getMax("kwh"),e=this._getMax("sek");return z`
      <div class="chart-container">
        ${mt.map(i=>this._renderPeriod(i,this.data[i.key],t,e))}
      </div>
      <div class="legend">
        ${yt.map(t=>z`
    ...
    `}_renderPeriod(t,e,i,s){return z`
      <div class="period-column">
        ...
        <div class="bars">
          ${yt.map(t=>{const r=e[t.key],a="kWh"===t.unit?i:s;return z`
    ...
    `}_getMax(t){if(!this.data)return 0;const e="kwh"===t?["own_use_kwh","sold_kwh"]:["own_use_sek","sold_sek"];let i=0;for(const t of mt){const s=this.data[t.key];for(const t of e)s[t]>i&&(i=s[t])}return i}_formatValue(t,e){return t>=1e3?`${(t/1e3).toFixed(1)}k`:t>=10?t.toFixed(0):t.toFixed(1)}};ft.styles=o`
    :host {
      display: block;
    }
  ...
  `,t([pt({attribute:!1})],ft.prototype,"data",void 0),ft=t([lt("period-summary-chart")],ft);let bt=class extends nt{constructor(){super(...arguments),this.entryId="",this._data=null,this._periodData=null,this._loading=!1,this._error=""}updated(t){t.has("hass")&&this.hass&&this.entryId&&!this._data&&!this._loading&&this._fetchData()}async _fetchData(){if(this.hass&&this.entryId){this._loading=!0,this._error="";try{const[t,e]=await Promise.all([this.hass.callWS({type:"my_solar_cells/get_overview",entry_id:this.entryId}),this.hass.callWS({type:"my_solar_cells/get_period_summaries",entry_id:this.entryId})]);this._data=t,this._periodData=e}catch(t){this._error=t.message||"Failed to fetch data"}this._loading=!1}}render(){if(this._loading)return z`<div class="loading">Loading overview...</div>`;if(this._error)return z`<div class="no-data">Error: ${this._error}</div>`;if(!this._data)return z`<div class="no-data">No data available</div>`;const t=this._data;return z`
    ...
    `],t([pt({attribute:!1})],At.prototype,"hass",void 0),t([pt()],At.prototype,"entryId",void 0),t([_t()],At.prototype,"_params",void 0),t([_t()],At.prototype,"_loading",void 0),t([_t()],At.prototype,"_fetched",void 0),t([_t()],At.prototype,"_error",void 0),t([_t()],At.prototype,"_editingYear",void 0),t([_t()],At.prototype,"_editValues",void 0),t([_t()],At.prototype,"_newYear",void 0),t([_t()],At.prototype,"_saving",void 0),t([_t()],At.prototype,"_minYear",void 0),t([_t()],At.prototype,"_maxYear",void 0),At=t([lt("yearly-params-view")],At);let kt=class extends nt{constructor(){super(...arguments),this.entryId="",this._projection=[],this._investment=0,this._loading=!1,this._error="",this._initialLoaded=!1,this._defaultPriceDev=5,this._defaultPanelDeg=.25}updated(t){t.has("hass")&&this.hass&&this.entryId&&!this._initialLoaded&&!this._loading&&this._fetchInitial()}async _fetchInitial(){if(this.hass&&this.entryId){this._loading=!0,this._error="";try{const t=await this.hass.callWS({type:"my_solar_cells/get_roi_projection",entry_id:this.entryId});this._projection=t.projection,this._investment=t.investment,this._defaultPriceDev=Math.round(1e4*(t.price_development-1))/100,this._defaultPanelDeg=Math.round(100*t.panel_degradation)/100,this._initialLoaded=!0}catch(t){this._error=t.message||"Failed to fetch ROI projection"}this._loading=!1}}async _onCalculate(){if(!this.hass||!this.entryId)return;const t=this.shadowRoot.getElementById("price-dev-input"),e=this.shadowRoot.getElementById("panel-deg-input"),i=parseFloat(t.value)||0,s=parseFloat(e.value)||0,r=1+i/100;this._loading=!0,this._error="";try{const t=await this.hass.callWS({type:"my_solar_cells/get_roi_projection",entry_id:this.entryId,price_development:r,panel_degradation:s});this._projection=t.projection,this._investment=t.investment}catch(t){this._error=t.message||"Failed to recalculate ROI projection"}this._loading=!1}_fmtInt(t){return Math.round(t).toLocaleString("sv-SE")}_fmtSek(t){return t.toLocaleString("sv-SE",{minimumFractionDigits:2,maximumFractionDigits:2})}_fmtPct(t){return t.toLocaleString("sv-SE",{minimumFractionDigits:1,maximumFractionDigits:1})}render(){return this._loading&&!this._initialLoaded?z`<div class="loading">Loading ROI projection...</div>`:this._error?z`<div class="no-data">Error: ${this._error}</div>`:this._projection.length?z`
      <div class="card">
    ...
    `],t([pt({attribute:!1})],kt.prototype,"hass",void 0),t([pt()],kt.prototype,"entryId",void 0),t([_t()],kt.prototype,"_projection",void 0),t([_t()],kt.prototype,"_investment",void 0),t([_t()],kt.prototype,"_loading",void 0),t([_t()],kt.prototype,"_error",void 0),t([_t()],kt.prototype,"_initialLoaded",void 0),kt=t([lt("roi-view")],kt);let Et=class extends nt{constructor(){super(...arguments),this._activeTab="overview"}get _entryId(){return this.panel?.config?.entry_id||""}render(){return z`
      <div class="content">
        <div class="header">

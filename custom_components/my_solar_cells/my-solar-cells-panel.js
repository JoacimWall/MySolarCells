...
`,ft=[{key:"own_use_kwh",label:"Own Use",color:"#4285f4",unit:"kWh"},{key:"sold_kwh",label:"Sold",color:"#34a853",unit:"kWh"},{key:"own_use_sek",label:"Own Use",color:"#8ab4f8",unit:"SEK"},{key:"sold_sek",label:"Sold",color:"#f4a742",unit:"SEK"}],yt=[{key:"today",label:"Today"},{key:"this_week",label:"This Week"},{key:"this_month",label:"This Month"},{key:"this_year",label:"This Year"}];let bt=class extends nt{render(){if(!this.data)return H;const t=this._getMax("kwh"),e=this._getMax("sek");return K`
    ...
    `}_renderPeriod(t,e,s,a){return K`
      <div class="period-column">
        ...
        <div class="bars">
          ${ft.map(t=>{const i=e[t.key],r="kWh"===t.unit?s:a;return K`
    ...
    `}_getMax(t){if(!this.data)return 0;const e="kwh"===t?["own_use_kwh","sold_kwh"]:["own_use_sek","sold_sek"];let s=0;for(const t of yt){const a=this.data[t.key];for(const t of e)a[t]>s&&(s=a[t])}return s}_formatValue(t,e){return t>=1e3?`${(t/1e3).toFixed(1)}k`:t>=10?t.toFixed(0):t.toFixed(1)}};bt.styles=o`
    :host {
      display: block;
    }

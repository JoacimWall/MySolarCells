            ...
            else
            {
                if (resultRoi.Model != null)
                {
                    if (firstTime)
                    {
                        ...
                        {
                            EstimateRoi = resultRoi.Model,
                            ReportPageType = ReportPageType.SavingEstimate,
                            ReportTitle = AppResources.Savings_Calculation
                        });
                        ReportData.Add(new ReportModel
                        {
                            Stats = resultHistory.Model.Item1,
                            ReportPageType = ReportPageType.YearsOverview,
                        ...
                        foreach (var item in resultHistory.Model.Item2)
                        {
                            ...
                            {
                                Stats = item,
                                ReportPageType = ReportPageType.YearDetails,

...
public class MoreViewModel : BaseViewModel
{
    ...
    private async Task<bool> ExportExcel(int homeId)
    {
        ...
        using (ExcelEngine excelEngine = new ExcelEngine())
        {
            ...
            worksheet.Range["A16"].Text = "Saved cost";
            worksheet.Range["A17"].Text = "Saved transfer fee";
            worksheet.Range["A18"].Text = "Saved energy tax";
            ...
            worksheet.Range["A21"].Text = "Total production kWh";
            worksheet.Range["A22"].Text = "Total interest";
            worksheet.Range["A23"].Text = "Result";
            worksheet.Range["A23"].CellStyle.Font.Bold = true;
            worksheet.Range["A23"].CellStyle.Color = Syncfusion.Drawing.Color.Orange;
            worksheet.Range["A1:A23"].CellStyle.HorizontalAlignment = ExcelHAlign.HAlignLeft;
            ...
            for (char c = 'B'; c < 'Z'; c++)
            {
                ...
                worksheet.Range[c.ToString() + "11"].Value = result.Model[index].RoiStats.TotalCompensationForProductionToGrid.ToString();
                worksheet.Range[c.ToString() + "12"].Value = result.Model[index].RoiStats.TotalSavedEnergyTaxReductionProductionToGrid.ToString();
                worksheet.Range[c.ToString() + "13"].Value = result.Model[index].RoiStats.SumProductionSold.ToString();
                ...
                worksheet.Range[c.ToString() + "15"].Value = result.Model[index].RoiStats.TotalProductionOwnUse.ToString();
                worksheet.Range[c.ToString() + "16"].Value = result.Model[index].RoiStats.TotalProductionOwnUseProfit.ToString();
                worksheet.Range[c.ToString() + "17"].Value = result.Model[index].RoiStats.TotalSavedTransferFeeProductionOwnUse.ToString();
                worksheet.Range[c.ToString() + "18"].Value = result.Model[index].RoiStats.TotalSavedEnergyTaxProductionOwnUse.ToString();
                worksheet.Range[c.ToString() + "19"].Value = result.Model[index].RoiStats.SumProductionOwnUse.ToString();
                worksheet.Range[c.ToString() + "19"].CellStyle.Font.Bold = true;
                worksheet.Range[c.ToString() + "19"].CellStyle.Color = Syncfusion.Drawing.Color.Orange;

                worksheet.Range[c.ToString() + "21"].Value = result.Model[index].RoiStats.TotalProduction.ToString();
                worksheet.Range[c.ToString() + "22"].Value = result.Model[index].RoiStats.TotalInterest.ToString();
                worksheet.Range[c.ToString() + "23"].Value = result.Model[index].RoiStats.TotalSaved.ToString();
            ...
            worksheet.Range["A25"].Text = "ROI";
            worksheet.Range["A25"].CellStyle.Font.Bold = true;
            worksheet.Range["A26"].Text = "Years until ROI";
            worksheet.Range["A27"].Text = "Total investment & lon";
            worksheet.Range["A28"].Text = "Total produced & saved";
            worksheet.Range["A29"].Text = "Left of investment cost";
            ...
            worksheet.Range["B29"].CellStyle.Font.Bold = true;
            worksheet.Range["B29"].CellStyle.Color = Syncfusion.Drawing.Color.Orange;
